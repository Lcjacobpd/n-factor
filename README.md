...
of dimensions to ultimately factor to. For example, the following will 
perform test for values in the range of 10-500 factored three ways.

```Shell
python3 test.py 500 --dim 3
```
